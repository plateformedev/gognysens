        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            <header class="page-header">
                <div class="container">
                    ...
                    <p class="lead">
                        <?php esc_html_e('Une question ? Un projet ? Contactez-nous.', 'cognisens'); ?>
                    </p>
                </div>
            </header>
                    ...
                    <div class="contact-grid">
                        ...
                        <div class="contact-form">
                            ...
                            if (function_exists('gravity_form')) {
                                ...
                                // Fallback form
                                ?>
                                <form class="cognisens-contact-form" method="post" action="">
...
/* Form styles */
.cognisens-contact-form .form-group {
    margin-bottom: 1.5rem;
}

.cognisens-contact-form label {
    display: block;
    font-size: 0.875rem;
    font-weight: 500;
...
.cognisens-contact-form input[type="text"],
.cognisens-contact-form input[type="email"],
.cognisens-contact-form input[type="tel"],
.cognisens-contact-form select,
.cognisens-contact-form textarea {
    width: 100%;
...
.cognisens-contact-form input:focus,
.cognisens-contact-form select:focus,
.cognisens-contact-form textarea:focus {
    outline: none;
