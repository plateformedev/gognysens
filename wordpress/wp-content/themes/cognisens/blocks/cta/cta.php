...
$block_classes = 'cognisens-cta cognisens-cta--' . esc_attr($style);
...
<section class="<?php echo esc_attr($block_classes); ?>">
    <div class="cognisens-cta__content">
        <?php if ($title): ?>
            <h2 class="cognisens-cta__title"><?php echo esc_html($title); ?></h2>
        <?php endif; ?>

        <?php if ($subtitle): ?>
            <p class="cognisens-cta__subtitle"><?php echo esc_html($subtitle); ?></p>
        <?php endif; ?>

        <?php if ($button_text): ?>
            <a href="<?php echo esc_url($button_link); ?>" class="cognisens-cta__button">
