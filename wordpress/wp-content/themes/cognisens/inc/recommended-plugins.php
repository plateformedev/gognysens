 ...
 */
function cognisens_get_recommended_plugins() {
    return array(
        // SEO
        array(
            'name'        => 'Rank Math SEO',
 ...
 */
function cognisens_missing_plugins_notice() {
    if (!current_user_can('install_plugins')) {
        return;
    }

    $plugins = cognisens_get_recommended_plugins();
    ...
    if (!empty($missing_required)) {
        ...
        <div class="notice notice-warning is-dismissible">
            <p><strong>Cognisens :</strong> Les plugins suivants sont requis pour le bon fonctionnement du theme :</p>
...
add_action('admin_notices', 'cognisens_missing_plugins_notice');

/**
 * RankMath SEO Configuration recommendations
 */
function cognisens_rankmath_defaults() {
    // These would be applied via import/export in RankMath
    return array(
        'titles' => array(
            'homepage_title'       => 'Cognisens - Expertise Bati Ancien & AMO Paris',
 ...
 */
function cognisens_complianz_defaults() {
    return array(
        'cookie_banner' => array(
            'position'         => 'bottom',
            'theme'            => 'minimal',
