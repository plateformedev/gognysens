 ...
 */
function cognisens_register_patterns() {
    // Hero Pattern
    register_block_pattern(
        'cognisens/hero',
        array(
            'title'       => __('Hero Cognisens', 'cognisens'),
            'description' => __('Section hero avec titre et CTA', 'cognisens'),
            'categories'  => array('cognisens'),
...
<!-- /wp:group -->',
    ...
    register_block_pattern(
        'cognisens/services-grid',
        array(
            'title'       => __('Grille Services', 'cognisens'),
            'description' => __('Grille de cartes services', 'cognisens'),
            'categories'  => array('cognisens'),
...
<!-- /wp:group -->',
    ...
    register_block_pattern(
        'cognisens/faq',
        array(
            'title'       => __('FAQ Cognisens', 'cognisens'),
            'description' => __('Section FAQ avec accordeon', 'cognisens'),
            'categories'  => array('cognisens'),
            'content'     => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|section","bottom":"var:preset|spacing|section"}}},"backgroundColor":"stone","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-stone-background-color has-background" style="padding-top:var(--wp--preset--spacing--section);padding-bottom:var(--wp--preset--spacing--section)">
<!-- wp:heading {"textAlign":"center"} -->
...
<p>L\'expert analyse et diagnostique. Il ne concoit pas et ne realise pas de travaux. La maitrise d\'oeuvre concoit et suit l\'execution des travaux. Cognisens est expert et AMO, pas maitre d\'oeuvre.</p>
...
<!-- /wp:group -->',
    ...
    register_block_pattern(
        'cognisens/pricing',
        array(
            'title'       => __('Tableau Tarifs', 'cognisens'),
            'description' => __('Affichage des tarifs', 'cognisens'),
            'categories'  => array('cognisens'),
            'content'     => '<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|section","bottom":"var:preset|spacing|section"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--section);padding-bottom:var(--wp--preset--spacing--section)">
<!-- wp:heading {"textAlign":"center"} -->
...
<!-- /wp:group -->',
    ...
    // CTA Section Pattern
    register_block_pattern(
        'cognisens/cta-section',
        array(
            'title'       => __('Section CTA', 'cognisens'),
            'description' => __('Appel a l\'action', 'cognisens'),
            'categories'  => array('cognisens'),
...
add_action('init', 'cognisens_register_patterns');

/**
 * Register ACF blocks (if ACF Pro installed)
 */
function cognisens_register_acf_blocks() {
    ...
    acf_register_block_type(array(
        'name'              => 'cognisens-faq',
        'title'             => __('FAQ Cognisens', 'cognisens'),
        'description'       => __('Bloc FAQ avec Schema.org', 'cognisens'),
    ...
    // Tarif Block
    acf_register_block_type(array(
        'name'              => 'cognisens-tarif',
        'title'             => __('Carte Tarif', 'cognisens'),
        'description'       => __('Affichage d\'un tarif', 'cognisens'),
...
add_action('acf/init', 'cognisens_register_acf_blocks');
