...
<section class="cognysens-faq" id="<?php echo esc_attr($block_id); ?>">
    <?php if ($title): ?>
        <h2 class="cognysens-faq__title"><?php echo esc_html($title); ?></h2>
    <?php endif; ?>

    <div class="cognysens-faq__list">
        ...
        ?>
            <details class="cognysens-faq__item">
                <summary class="cognysens-faq__question">
                    <?php echo esc_html($question); ?>
                </summary>
                <div class="cognysens-faq__answer">
