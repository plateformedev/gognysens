...
function cognysens_breadcrumb() {
    ...
    $output .= '<a href="' . esc_url(home_url('/')) . '">' . esc_html__('Accueil', 'cognysens') . '</a>';
 ...
 */
function cognysens_section_title($title, $subtitle = '', $tag = 'h2') {
 ...
 * CTA Button
 */
function cognysens_cta_button($text, $url, $style = 'primary') {
 ...
 */
function cognysens_format_price($price, $suffix = ' HT') {
 ...
 * Get contact info
 */
function cognysens_get_contact() {
    return array(
 ...
 */
function cognysens_phone_link($phone) {
 ...
 */
function cognysens_is_section($section) {
    if (!is_page()) {
        return false;
    }
 ...
 */
function cognysens_get_related_pages($section, $limit = 3) {
 ...
 */
function cognysens_get_location_data($slug) {
    $locations = array(
 ...
 */
function cognysens_local_business_schema($location_data) {
    ...
    $schema = array(
        ...
        '@type' => 'LocalBusiness',
        'name' => 'Cognysens - Expert Bati Ancien ' . $location_data['name'],
