 ...
 */
function cognysens_register_acf_fields() {
        ...
        'location' => array(
            array(
                array(
                    'param' => 'block',
                    'operator' => '==',
                    'value' => 'acf/cognysens-cta',
                ),
            ),
        ),
    ));
}
add_action('acf/init', 'cognysens_register_acf_fields');

/**
 * Register ACF blocks from block.json
 */
function cognysens_register_acf_block_types() {
...
add_action('init', 'cognysens_register_acf_block_types');
